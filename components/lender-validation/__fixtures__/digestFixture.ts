...
export const MOCK_PLANTS: DigestPlantRow[] = [
  {
    // plant-01: 2024 COD, 2024 senior-debt evidence → HIGH priority
    plantId:              'plant-01',
    eiaPlantCode:         '57394',
    ...
    lat:                  33.45,
    lng:                  -100.9,
    evidenceArticleDate:  '2024-01-10T00:00:00Z',
    evidenceAgeYears:     2.4,
    expectedTenorYears:   10,
    loanLikelyActivePct:  94,
    recentNewsCount:      3,
    priorityScore:        81,
    priorityBand:         'high',
    aiPriorityBand:       'high',
    aiPriorityReason:     '2024 COD with recent senior-debt evidence; loan well within 10-year tenor window.',
  },
  {
    // plant-02: 2022 COD, 2022 senior-debt, underperforming → HIGH
    plantId:              'plant-02',
    eiaPlantCode:         '60011',
    ...
    lat:                  33.82,
    lng:                  -115.4,
    evidenceArticleDate:  '2022-04-15T00:00:00Z',
    evidenceAgeYears:     4.1,
    expectedTenorYears:   10,
    loanLikelyActivePct:  88,
    recentNewsCount:      2,
    priorityScore:        72,
    priorityBand:         'high',
    aiPriorityBand:       'high',
    aiPriorityReason:     'Active loan (4yr of 10yr tenor); PPA dispute creates refinancing urgency.',
  },
  {
    // plant-03: 2023 COD, construction loan (tenor 2yr) → already within window but short
    plantId:              'plant-03',
    eiaPlantCode:         '63540',
    ...
    lat:                  47.1,
    lng:                  -101.7,
    evidenceArticleDate:  '2023-06-20T00:00:00Z',
    evidenceAgeYears:     2.9,
    expectedTenorYears:   2,
    loanLikelyActivePct:  41,
    recentNewsCount:      0,
    priorityScore:        44,
    priorityBand:         'medium',
    aiPriorityBand:       'medium',
    aiPriorityReason:     'Construction loan from 2023 likely refinanced to permanent debt at COD; track new lender.',
  },
  {
    // plant-04: 2018 COD, term loan, highly distressed → MEDIUM (active + distress)
    plantId:              'plant-04',
    eiaPlantCode:         '58720',
    ...
    lat:                  35.9,
    lng:                  -114.8,
    evidenceArticleDate:  '2021-03-01T00:00:00Z',
    evidenceAgeYears:     5.3,
    expectedTenorYears:   7,
    loanLikelyActivePct:  69,
    recentNewsCount:      1,
    priorityScore:        62,
    priorityBand:         'medium',
    aiPriorityBand:       'high',
    aiPriorityReason:     'PPA dispute + severe underperformance (-5.4pp) signal imminent distress financing need.',
  },
  {
    // plant-05: 2019 COD, senior debt → MEDIUM (8yr of 10yr tenor)
    plantId:              'plant-05',
    eiaPlantCode:         '61300',
    ...
    lat:                  35.5,
    lng:                  -101.5,
    evidenceArticleDate:  '2018-09-01T00:00:00Z',
    evidenceAgeYears:     7.8,
    expectedTenorYears:   10,
    loanLikelyActivePct:  57,
    recentNewsCount:      0,
    priorityScore:        41,
    priorityBand:         'medium',
    aiPriorityBand:       'medium',
    aiPriorityReason:     'Loan nearing end of tenor; healthy CF means refinancing rather than distress.',
  },
  {
    // plant-06: 2014 COD, mezzanine (5yr tenor) → LOW
    plantId:              'plant-06',
    eiaPlantCode:         '55801',
    ...
    lat:                  33.1,
    lng:                  -112.0,
    evidenceArticleDate:  '2014-08-01T00:00:00Z',
    evidenceAgeYears:     11.8,
    expectedTenorYears:   5,
    loanLikelyActivePct:  18,
    recentNewsCount:      0,
    priorityScore:        27,
    priorityBand:         'low',
    aiPriorityBand:       'low',
    aiPriorityReason:     'Mezzanine evidence from 2014 on an 11-year-old plant; original tranche almost certainly matured.',
  },
  {
    // plant-07: 2010 COD, construction loan from 2009 → COLD (user's exact example)
    plantId:              'plant-07',
    eiaPlantCode:         '64102',
    ...
    lng:                  null,
    evidenceArticleDate:  '2009-07-15T00:00:00Z',
    evidenceAgeYears:     16.9,
    expectedTenorYears:   2,
    loanLikelyActivePct:  2,
    recentNewsCount:      0,
    priorityScore:        11,
    priorityBand:         'cold',
    aiPriorityBand:       'cold',
    aiPriorityReason:     'Construction loan from 2009; plant online since 2010 — original loan matured ~16 years ago.',
  },
];

...
def upsert_articles(sb: Client, articles: list[dict], batch_size: int = 50) -> int:
    rows = []
    for a in articles:
        try:
        ...
        rows.append({
            ...
            "query_tag":            f"curtailed:{a['plant_code']}",

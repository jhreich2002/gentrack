...
async function generatePlantNews(
  plant: { code: string; name: string; owner: string; fuel: string; state: string; mw: number },
  geminiKey: string,
...
Cover a MIX of story types across the ${ARTICLES_PER_PLANT} articles â€” e.g. outage/maintenance,
regulatory/permitting, financial/M&A, community/environmental, capacity expansion.
Make dates realistic: within the last 14 days before ${today}.
